...
<body class="bg-blue-100 min-h-screen flex flex-col">
    ...
    <header class="bg-white shadow-md p-4 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <h1 class="text-xl font-bold text-blue-700">🎬 Absolute Cinema - Admin Page</h1>
        ...
        <a href="logout_admin.php" class="text-blue-600 hover:underline">Logout</a>
    </header>

    <main class="flex-1 container mx-auto px-4 py-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold">Daftar Film</h2>
            <a href="tambah_film.php"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php if ($searching): ?>
                <?php if (mysqli_num_rows($result) > 0): ?>
                    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                        <?php include 'card_film_admin.php'; ?>
                    <?php endwhile; ?>
                <?php else: ?>
            ...
            <?php else: ?>
                <div class="col-span-full">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">🎥 Sedang Tayang:</h3>
                </div>
                ...
                <div class="col-span-full mt-6">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">🎞️ Segera Tayang:</h3>
                </div>
    ...
    <footer class="bg-white text-center text-gray-600 p-4 shadow-inner mt-auto">
        <p>© Absolute Cinema - All Rights Reserved</p>
    </footer>
